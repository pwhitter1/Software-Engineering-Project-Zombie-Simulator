package zombie;
	...
	public class AlphaZombie {
		...
		public void initialize(ZombieModel modelArg) {
			...
			if((model.getColor(tempx, tempy) == Color.BLACK && //zombies can be on black or blue
			...
			(model.getColor(tempx, tempy) == Color.BLUE &&
					...
					model.getColor(tempx + 1, tempy + 1 ) == Color.BLUE)) {
				model.setColor(tempx, tempy, Color.RED);
			}
